...
**0.2 Website** – the website operating at thallium.vercel.app and its associated services.<br>
...
**1.1** These Terms of Service define the rules for using the Website and Services provided by the Service Provider and constitute an agreement between the Service Provider and the User.<br>
...
**1.6** Every User has the right to express opinions about the project.<br>
...
**Intended Use**<br>
**2.1** The Website and Services may be used by persons over the age of 16 who have full legal capacity, unless specific provisions state otherwise.<br>
...
- refuse to provide Services without providing detailed reasons, to the extent permitted by law<br>
...
**4.1** All copyrights to the Website and its elements belong to the Service Provider or other authorized entities, if explicitly stated.<br>
...
### <br> 10. Projects and Cooperation <br><br>
**10.1** Thallium Studio may cooperate with external projects, which become partner projects. Cooperation is based on mutual trust, compliance with these Terms, and Thallium Studio's legal documents.<br>
**10.2** The owner of a partner project is obliged to ensure that the project complies with Thallium Studio's legal documents, applicable law, and quality standards set by Thallium Studio.<br>
**10.3** Each partner project must have its own terms of service and privacy policy, in accordance with Thallium Studio's guidelines. These documents must be available to project users.<br>
**10.4** Partner projects should have their own technical support and user support team, unless otherwise agreed with Thallium Studio.<br>
**10.5** Partner projects are managed independently by the project owner, who is fully responsible for their operation, legal compliance, and user safety.<br>
**10.6** Thallium Studio reserves the right to intervene in any partner project, including conducting audits, issuing binding instructions, and requiring changes to ensure compliance with Thallium Studio's documents.<br>
**10.7** Thallium Studio has the right to terminate cooperation with any partner project without giving a reason, with 14 days' notice, unless the agreement provides otherwise.<br>
**10.8** All work, contributions, materials, or software created for Thallium Studio as part of the cooperation become the property of Thallium Studio, unless otherwise agreed in writing.<br>
**10.9** Partner projects may not violate any legal documents, policies, rules, or good practices of Thallium Studio. In case of violation, Thallium Studio has the right to immediately suspend cooperation.<br>
**10.10** Any disputes between Thallium Studio and a partner project are resolved amicably in the first instance, and in the absence of agreement – by the court competent for the seat of Thallium Studio.<br>
**10.11** Partner projects are required to regularly report progress, report incidents, and cooperate with Thallium Studio in the areas of development, security, and compliance.<br>
**10.12** Detailed terms of cooperation, scope of support, and liability may be specified in a separate agreement between Thallium Studio and the partner project.<br>
**10.13** The exact requirements that a project must meet within 14 days of confirming the start of cooperation are set out in the documentation in the cooperation category.<br>

### <br> 9. Final Provisions <br><br>
**9.1** The Service Provider reserves the right to temporarily or permanently suspend Services without giving a reason, subject to consumer rights under the law.<br>
**9.2** The Terms come into effect upon publication and apply to all Users.<br>
**9.3** In matters not regulated by these Terms, Polish law and European Union law shall apply.<br>
